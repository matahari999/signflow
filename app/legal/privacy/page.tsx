  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-3xl mx-auto px-8 py-16 prose prose-sm">
        ...
        <p>We use your information to provide and improve the SignFlow service, send contract signing links to parties you designate, process payments via Lemon Squeezy, and communicate with you about your account.</p>
        ...
        <p>We use the following third-party services: Supabase (database and authentication), Lemon Squeezy (payment processing), Resend (email delivery), and Vercel (hosting). Each service has its own privacy policy governing data handling.</p>
        ...
        <h2>6. Your Rights</h2>
        <p>You have the right to access, correct, or delete your personal data. You may export your data or request account deletion by emailing privacy@signflow.app.</p>

        <h2>7. Contact</h2>
        <p>For privacy-related inquiries: <strong>privacy@signflow.app</strong></p>
      </main>
    </div>
  )
}
