  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-3xl mx-auto px-8 py-16 prose prose-sm">
        ...
        <p>SignFlow offers a Free tier and a Pro subscription at $5/month. All payments are processed securely by Lemon Squeezy. You may cancel your subscription at any time; access to Pro features continues until the end of the billing period. Refunds are handled per Lemon Squeezy's refund policy.</p>
        ...
        <h2>9. Contact</h2>
        <p>For questions: <strong>legal@signflow.app</strong></p>
      </main>
    </div>
  )
}
